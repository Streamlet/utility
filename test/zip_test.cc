...
TEST(zip_test, single_file) {
  ...
  ASSERT_EQ(xl::zip::zip_compress(xl::path::join(_T("test_root"), _T("test.zip")).c_str(),
                                  xl::path::join(_T("test_root"), _T("f1")).c_str()),
            true);
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("test.zip")).c_str(), "f1"), "content");
  ASSERT_EQ(xl::zip::zip_extract(xl::path::join(_T("test_root"), _T("test.zip")).c_str(),
...
TEST(zip_test, single_directory) {
  ...
  ASSERT_EQ(xl::zip::zip_compress(xl::path::join(_T("test_root"), _T("test.zip")).c_str(),
            ...
            true);
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("test.zip")).c_str(), "d1/f1"), "content");
  ASSERT_EQ(xl::zip::zip_extract(xl::path::join(_T("test_root"), _T("test.zip")).c_str(),
                                 xl::path::join(_T("test_root"), _T("unzip")).c_str()),
            true);
...
TEST(zip_test, directory_tree) {
  ...
  ASSERT_EQ(xl::zip::zip_compress(xl::path::join(_T("test_root"), _T("test.zip")).c_str(),
                                  xl::path::join(_T("test_root"), _T("d1")).c_str()),
            true);
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("test.zip")).c_str(), "d1/f1"), "content1");
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("test.zip")).c_str(), "d1/d2/f2"), "content2");
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("test.zip")).c_str(), "d1/d2/d3/f3"), "content3");
...
TEST(zip_test, non_ascii_file_name) {
  ...
  ASSERT_EQ(xl::file::write(xl::path::join(_T("test_root"), _T("目录1"), _T("目录2"), _T("目录3"), _T("文件3")).c_str(),
                            "内容3"),
            true);
  ASSERT_EQ(xl::zip::zip_compress(xl::path::join(_T("test_root"), _T("测试.zip")).c_str(),
                                  xl::path::join(_T("test_root"), _T("目录1")).c_str()),
            true);
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("测试.zip")).c_str(), "目录1/文件1"), "内容1");
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("测试.zip")).c_str(), "目录1/目录2/文件2"),
            "内容2");
  ASSERT_EQ(xl::zip::zip_read_file(xl::path::join(_T("test_root"), _T("测试.zip")).c_str(), "目录1/目录2/目录3/文件3"),
            "内容3");

  ASSERT_EQ(xl::zip::zip_extract(xl::path::join(_T("test_root"), _T("测试.zip")).c_str(),
